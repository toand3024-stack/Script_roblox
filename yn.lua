...
TitleText.Text = "FPS GOD  |  toandinh"  -- Đã đổi thành toandinh
...
MinimizeBtn.MouseButton1Click:Connect(function()
    ...
    -- Đặt vị trí nút mở ngay vị trí cũ của menu (có thể điều chỉnh)
...
print("[FPS GOD MENU v15] toandinh UI loaded successfully!")
```
