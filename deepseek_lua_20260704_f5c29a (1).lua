...
local Settings = {
    ...
    -- Troll
    FakeLag = false,
    FakeLagIntensity = 200, -- mặc định 200ms
    ChatSpam = false,
...
-- ===================== TROLL TAB (SỬA LẠI BỐ CỤC & NÂNG CẤP FAKE LAG) =====================
local trollFrame = TabFrames[5]

-- Fake Lag (nâng cấp: tăng max lên 2000ms, thêm label trạng thái)
...
-- Label hiển thị trạng thái Fake Lag
...
-- Sit on Head (dùng Dropdown như file v16)
...
for _, p in ipairs(Players:GetPlayers()) do
    if p ~= LocalPlayer then table.insert(allPlayers, p.Name) end
end
